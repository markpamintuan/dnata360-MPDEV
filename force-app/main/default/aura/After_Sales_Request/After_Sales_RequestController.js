({
    doInit : function(component, event, helper) {
        ...
        setTimeout(function(){				       
				...
				action.setParams({ "brand" : brand , "actiontype" : "After Sales Request" });
                        ...
                        if(parentId.startsWith("001")){
							...
							createRecordEvent.setParams({
								...
								"defaultFieldValues": {
									...
									"Subject": "After Sales Request for " + parentRecordDetails.Name
								}
							});
							...
							createRecordEvent.setParams({
								...
								"defaultFieldValues": {
									...
									"Subject": "After Sales Request for " + parentRecordDetails.Org_Account_Name__r.Name
								}
							});
							createRecordEvent.fire();
						}
